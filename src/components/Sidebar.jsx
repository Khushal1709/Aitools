...
export default function Sidebar() {
  ...
  const allTools = [
    ...
    { label: "Text To Handwriting Converter", icon: <TbTransform />, link: "/Text" },
    ...
    { label: "SVG Pattern Generator", icon: <TbFileTypeSvg />, link: "/SVGpattern" },
    ...
    { label: "CSS Background Pattern Generator", icon: <TbBackground />, link: "/CSSbackgroundpattern" },
    { label: "CSS Cubic", icon: <LuSpline />, link: "/Csscubic" },
    { label: "CSS Glassmorphism Generator", icon: <IoMdPhonePortrait />, link: "/Cssglassmorphism" },
    { label: "CSS Text Glitch Effect Generator", icon: <CgGoogle />, link: "/Csstextglitch" },
    ...
    { label: "CSS Border Radius Generator", icon: <AiOutlineRadiusUpright />, link: "/Borderradiusgenerator" },
    { label: "Code to Image Converter", icon: <RiCodeBlock />, link: "/CodetoImage" },
    { label: "URL Slug Generator", icon: <FaLink />, link: "/Slug" },
    { label: "React Native Shadow Generator", icon: <FaReact />, link: "/Shadow" },
    { label: "Base64 Encoder/Decoder", icon: <FaBrain />, link: "/BaseEncoderDecoder" },
